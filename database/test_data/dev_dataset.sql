...
49	Introduction to web sustainability	What can web designers and developers do to build a more sustainable web? This post explores the environmental impacts of web technologies and looks at some of the ways we can build greener websites.	https://developer.mozilla.org/en-US/blog/introduction-to-web-sustainability/	2023-10-11 00:00:00	3	2
50	Migrating from GitHub to GitLab seamlessly: A step-by-step guide	Thinking about making the move from GitHub to GitLab? This guide demystifies the migration process, addressing common concerns for DevSecOps teams that are looking to seamlessly transition between the two platforms. This post provides a...	https://developer.mozilla.org/en-US/blog/migrating-from-github-to-gitlab-seamlessly-a-step-by-step-guide/	2023-10-05 00:00:00	3	2
51	Announcing the MDN front-end developer curriculum	MDN has created a curriculum for aspiring front-end developers to build a rewarding and successful career. Take a look at the curriculum, who it's for, and the research it's based on.	https://developer.mozilla.org/en-US/blog/announcing-mdn-front-end-developer-curriculum/	2023-08-14 00:00:00	3	2
52	Creating custom easing effects in CSS animations using the linear() function	The new CSS linear() timing function enables custom easing in animations. Explore how linear() works compared with other timing functions used for easing, with practical examples.	https://developer.mozilla.org/en-US/blog/custom-easing-in-css-with-linear/	2023-08-01 00:00:00	3	2
53	Securing your CDN: Why and how should you use SRI	Relying on external resources for your website is always fraught with risks. Learn how to protect your website and its visitors by using SRI to secure third-party content.	https://developer.mozilla.org/en-US/blog/securing-cdn-using-sri-why-how/	2023-07-21 00:00:00	3	2
54	Scroll progress animations in CSS	Scroll-driven animations are coming to CSS! In this post, we'll look at a few types of animations and learn how to link them to the scroll progress of a container.	https://developer.mozilla.org/en-US/blog/scroll-progress-animations-in-css/	2023-07-14 00:00:00	3	2
55	Reflections on AI Explain: A postmortem	We recently launched a feature called AI Explain, but we have rolled this back for now. In this post, we look into the story behind AI Explain: its development, launch, and the reasons that led us to press the pause button.	https://developer.mozilla.org/en-US/blog/ai-explain-postmortem/	2023-07-11 00:00:00	3	2
56	Developer essentials: How to search code using grep	grep is a powerful tool for searching code from the terminal. This post will show you how to use grep and why it's an essential developer tool.	https://developer.mozilla.org/en-US/blog/searching-code-with-grep/	2023-07-03 00:00:00	3	2
57	Introducing AI Help (Beta): Your Companion for Web Development	We're introducing an AI assistant powered by MDN and OpenAI GPT 3.5 to answer all your web development questions in real time.	https://developer.mozilla.org/en-US/blog/introducing-ai-help/	2023-06-27 00:00:00	3	2
58	Learn how to use hue in CSS colors with HSL	Hues are a bright way to define colors in CSS. Learn about hues, color wheels, how to use color functions, and how you can create vibrant color palettes for your website using hue.	https://developer.mozilla.org/en-US/blog/learn-css-hues-colors-hsl/	2023-06-26 00:00:00	3	2
59	Introducing the MDN Playground: Bring your code to life!	MDN is launching a code Playground. Users can prototype ideas and expand all live samples into an interactive experience.	https://developer.mozilla.org/en-US/blog/introducing-the-mdn-playground/	2023-06-22 00:00:00	3	2
60	MDN doc updates: CSS selectors & media queries, WebGPU & WebTransport APIs, Progressive web apps	Discover CSS :lang(), experimental media queries, manipulating graphics with WebGPU, client-server communication with WebTransport, ECMAScript module support, and more.	https://developer.mozilla.org/en-US/blog/mdn-docs-june-2023/	2023-06-13 00:00:00	3	2
61	How to draw any regular shape with just one JavaScript function	Learn how to use JavaScript to draw any regular shape to a HTML canvas with a single function, and how to modify it to draw multiple shapes.	https://developer.mozilla.org/en-US/blog/javascript-shape-drawing-function/	2023-05-26 00:00:00	3	2
62	New reference pages on MDN for JavaScript regular expressions	See the latest updates to the MDN reference pages about JavaScript regular expressions, including new sections on sub-features and browser compatibility information.	https://developer.mozilla.org/en-US/blog/regular-expressions-reference-updates/	2023-05-23 00:00:00	3	2
63	Celebrating Global Accessibility Awareness Day	In celebration of Global Accessibility Awareness Day in 2023, we share some tools and guidelines to help you make the web more accessible.	https://developer.mozilla.org/en-US/blog/accessibility-celebrating-gaad-2023/	2023-05-18 00:00:00	3	2
64	Using HTML landmark roles to improve accessibility	Learn what HTML landmark roles are, how they improve accessibility, and how you can include them on your website effectively.	https://developer.mozilla.org/en-US/blog/aria-accessibility-html-landmark-roles/	2023-05-15 00:00:00	3	2
65	Introducing Baseline: a unified view of stable web features	MDN leads the way in implementing WebDX community group's efforts, delivering a clear and simple baseline for the web platform to developers.	https://developer.mozilla.org/en-US/blog/baseline-unified-view-stable-web-features/	2023-05-10 00:00:00	3	2
66	How :not() chains multiple selectors	Learn how the CSS `:not()` pseudo-class behaves when multiple selectors are passed as argument.	https://developer.mozilla.org/en-US/blog/css-not-pseudo-multiple-selectors/	2023-05-05 00:00:00	3	2
67	New functions, gradients, and hues in CSS colors (Level 4)	Learn what's new in CSS Colors Module Level 4, including color spaces, color functions, fancy gradients, and support for wide-gamut displays.	https://developer.mozilla.org/en-US/blog/css-color-module-level-4/	2023-05-03 00:00:00	3	2
68	Welcome to the MDN blog	The MDN blog publishes web development news, tutorials, and insights as an extension of MDN Web Docs, helping you discover, learn, and create for the web.	https://developer.mozilla.org/en-US/blog/welcome-to-the-MDN-blog/	2023-05-03 00:00:00	3	2
69	Rewriting Strangler Fig	Two decades ago, I posted that I found that the strangler fig plant was an interesting metaphor for the gradual replacement of a legacy system. I didn’t refer to the metaphor since, but meanwhile it grew a life of its own. Other people increasingly...	https://martinfowler.com/articles/2024-strangler-fig-rewrite.html	2024-08-22 15:51:00	4	2
...
236	OpenBSD : why and how	The only operating system I use on my computers is not Mac, not Windows, and not even Linux. It’s OpenBSD, and I love it so much. So I figured I should say a little something about why, and how you can try it. It’s probably not for you. It’s...	https://sive.rs/openbsd	2018-04-20 00:00:00	1	3
237	Moving for good	You are the way you are because of what you’ve experienced. Your country, family, town, random circumstances, and friends have shaped the way you think. If you had grown up on the other side of the world, you would have a different set of values...	https://sive.rs/mfg	2018-03-31 00:00:00	1	3
...
279	Disconnect	All the best, happiest, and most creatively productive times in my life have something in common: being disconnected. No internet. No TV. No phone. No people. Long uninterrupted solitude. When I was twenty-two, I quit my job and spent five months...	https://sive.rs/dc	2016-07-27 00:00:00	1	3
280	Don’t add your two cents	“My two cents” is American slang for adding a small opinion or suggestion. An employee says to the boss, “I’ve been working for the past two weeks on this new design. What do you think?” The boss says, “Good job. Maybe just change the blue to...	https://sive.rs/2c	2016-07-25 00:00:00	1	3
281	Possible futures	I occasionally get a big vision for my future — a huge project that will take many months or years. Something exciting and very worth doing. I’ll do a bunch of research, make a bunch of plans, and feel like I’ve made a big decision on a new...	https://sive.rs/futures	2016-04-27 00:00:00	1	3
282	Singing the counter-melody	My advice and opinions may sound strange on their own. Do you know what musical counterpoint is? Underneath the main melody, you have a counter-melody that goes against it, and together they make harmony. This is different from harmonizing, where...	https://sive.rs/counter	2016-04-21 00:00:00	1	3
283	How to stop being rich and happy	(part of the “do this” directives) 1. Prioritize lifestyle design. You’ve made it, so it’s all about you, now.  Make your dreams come true. Shape your surroundings to please your every desire. Make your immediate gratification the most...	https://sive.rs/d1x	2016-04-18 00:00:00	1	3
284	How to be useful to others	(part of the “do this” directives) 1. Get famous. Do everything in public and for the public. The more people you reach, the more useful you are. The opposite is hiding, which is of no use to anyone. 2. Get rich. Money is neutral proof you’re...	https://sive.rs/d1u	2016-04-18 00:00:00	1	3
285	How to thrive in an unknowable future	(part of the “do this” directives) 1. Prepare for the worst. Since you have no idea what the future may bring, be open to the best and the worst. But the best case scenario doesn’t need your preparation or your attention. So mentally and...	https://sive.rs/d1t	2016-04-18 00:00:00	1	3
286	What to do when you get successful	(part of the “do this” directives) 1. Change yes to “Hell yeah!” or no. Once successful, you need to switch strategies. To get successful, you had to say yes to everything. Now if you continue doing that, you’ll drown in all the...	https://sive.rs/d1s	2016-04-18 00:00:00	1	3
287	How to get rich	(part of the “do this” directives) 1. Live where luck strikes. Live where everything is happening, where the money is flowing, where careers are being made, where your role models live. Once there, be as in the game as anyone can be. Be...	https://sive.rs/d1r	2016-04-18 00:00:00	1	3
288	How to like people	(part of the “do this” directives) 1. Assume it’s their last day. Everyone talks about living like it’s your last day on earth. Instead, to appreciate someone, live like it’s their last day on earth. Treat them accordingly.  Try to fulfill...	https://sive.rs/d1p	2016-04-18 00:00:00	1	3
289	Do this. Directives — part 1	First see “just tell me what to do” for context. These directives will take another form some day, with more details and references. And there are many more to come. But I decided to post this outline now, because so many people have asked for...	https://sive.rs/d1	2016-04-18 00:00:00	1	3
...
333	Experimental Schedutil Patches Yield 30% Boost To Web Browser Benchmark On Linux	Google engineer Qais Yousef has posted a set of 16 patches for the "Schedutil" scheduler utilization code within the Linux kernel to better manage system response time. Schedutil is often used by default on many Linux distributions and with these...	https://www.phoronix.com/news/Schedutil-30p-Speedometer-Boost	2024-08-21 13:51:17	7	5
334	Linux Support Emerging For The Samsung Galaxy Book4 Edge X1 Elite Laptop	Following all of the Snapdragon X1 upstream enablement work over the past number of months by Qualcomm and then DeviceTree additions emerging for enabling the likes of the ASUS Vivobook S 15, Lenovo Yoga Slim 7x, Lenovo ThinkPad T14s Gen 6, and...	https://www.phoronix.com/news/Samsung-Galaxy-Book4-Edge-Linux	2024-08-21 12:46:58	7	5
335	Zed Code Editor Begins Adding AI Features Powered By Anthropic's Claude	Zed, the code/text editor being developed by former Atom editor developers, has continued to gain interest among developers since going open-source, being written in the Rust programming language, and native Linux builds taking shape. The latest...	https://www.phoronix.com/news/Zed-Adding-AI-Features	2024-08-21 10:30:05	7	5
336	SVT-AV1 2.2 Delivers More Performance Improvements	SVT-AV1 2.2 is now available for this leading open-source AV1 video encoder. With this new version comes yet more performance optimizations...	https://www.phoronix.com/news/SVT-AV1-2.2-Released	2024-08-21 10:13:03	7	5
337	VirtualBox 7.1 Beta 2 Released For This Big Oracle Virtualization Update	Released last month was the VirtualBox 7.1 Beta 1 virtualization software release from Oracle. This new version is bringing a modernized GUI, Wayland clipboard sharing, and other improvements. Released yesterday was the second beta of this big...	https://www.phoronix.com/news/VirtualBox-7.1-Beta-2	2024-08-21 10:04:12	7	5
338	GIMP 3.0 Enters String Freeze, Inching Closer To Release	Today marks the beginning of the string freeze for the long-awaited GIMP 3.0 open-source image editor release as one of the leading free software alternatives to Adobe Photoshop...	https://www.phoronix.com/news/GIMP-3.0-String-Freeze	2024-08-20 18:25:06	7	5
339	Linux Patches Work To Upstream Raspberry Pi's RP1 PCI Device Support	Andrea della Porta of SUSE has been working on upstreaming the Linux kernel support to boot the Raspberry Pi 5 on a mainline kernel. Over the past few months Andrea has posted a number of different patches derived in part from Raspberry Pi's...	https://www.phoronix.com/news/Raspberry-Pi-RP1-Linux-Patches	2024-08-20 16:47:00	7	5
340	Intel Continues To Show AMD The Importance Of Software Optimizations: 16% More Ryzen 9 9950X Performance	As part of my ongoing AMD Ryzen 9 9950X Linux testing, last week I provided a look at the AVX-512 benefits to Zen 5 and also the Windows vs. Linux performance for the Ryzen 9 9950X. For sharing today is a look at multiple Linux distributions up and...	https://www.phoronix.com/review/linux-os-amd-ryzen9-9950x	2024-08-20 14:30:00	7	5
341	Granite Rapids Idle/P-State Work For Linux 6.12 & An Important AMD Energy Reporting Fix	Queued yesterday into the Linux power management subsystem's "linux-next" branch ahead of the Linux 6.12 kernel are some important additions for Intel processors and also an important fix for AMD processors to enjoy package power monitoring...	https://www.phoronix.com/news/Linux-6.12-Intel-AMD-PM-Early	2024-08-20 13:36:17	7	5
...
343	Ubuntu Fixes Old NVIDIA Wayland Support For GNOME, Hiring More Desktop Engineers	There are a few interesting bits of information as part of this week's updates from the Ubuntu Desktop Team Integration Squad...	https://www.phoronix.com/news/Ubuntu-Fixes-EGLDevice-GNOME	2024-08-20 10:40:52	7	5
344	Proposed Vulkan Extension To Improve Memory Sharing With Apple's Metal	LunarG engineer Aitor Camacho Larrondo has proposed VK_EXT_external_memory_metal, a new extension for the Vulkan API to allow for more easily sharing memory objects from Vulkan with Apple's Metal...	https://www.phoronix.com/news/VK_EXT_external_memory_metal	2024-08-20 10:26:15	7	5
345	ASUS ROG Ally X & GT7868Q See HID Fixes With Linux 6.11	A new batch of HID subsystem fixes were merged today for the ongoing Linux 6.11 kernel development...	https://www.phoronix.com/news/Linux-6.11-HID-ROG-Ally-X-GT786	2024-08-19 19:32:17	7	5
346	AMD & FreeBSD Begin Collaborating Over OS Improvements	The FreeBSD open-source operating system project published their Q2'2024 status report that outlines some interesting work happening to this leading BSD project...	https://www.phoronix.com/news/FreeBSD-Q2-2024-Improvements	2024-08-19 16:51:00	7	5
347	NVIDIA RTX 2000 & RTX 4000 Ada Generation Linux Performance	NVIDIA recently sent over their RTX 2000 Ada Generation and RTX 4000 Ada Generation graphics cards suited for designers, engineers, and creative professionals. In my testing the past several weeks these professional graphics cards have been working...	https://www.phoronix.com/review/nvidia-rtx-2000-4000-ada	2024-08-19 15:00:00	7	5
348	Fedora 41 To Rely On PipeWire By Default For Firefox Camera Handling	Red Hat engineer Jan Grulich has provided an update today on PipeWire camera handling with the upcoming Fedora 41 release...	https://www.phoronix.com/news/Fedora-41-Firefox-PipeWire-Cam	2024-08-19 12:42:29	7	5
349	Feral's GameMode 1.8.2 Fixes Hybrid CPU Core Pinning	GameMode as the open-source daemon from Feral Interactive to optimize Linux system performance on-demand when running games is out with its first release of 2024...	https://www.phoronix.com/news/GameMode-1.8.2-Released	2024-08-19 12:26:45	7	5
350	Linux 6.11 Kernel Performance On The AMD Ryzen 9 9000 Series	If you are picking up one of the new AMD Ryzen 9000 series desktop processors soon for Linux use, you may be wondering whether it's worthwhile or even necessary moving to the latest Linux kernel code compared to the likes of Ubuntu 24.04 LTS that...	https://www.phoronix.com/news/Linux-6.11-AMD-Ryzen-9-9950X	2024-08-19 10:49:10	7	5
